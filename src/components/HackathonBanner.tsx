      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 py-2 sm:py-2.5">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 sm:gap-3">
          ...
          <div className="flex items-center gap-2 sm:gap-2.5 flex-wrap">
            <span className="flex items-center gap-1.5 px-2.5 py-0.5 rounded-full bg-cyan-500/10 border border-cyan-500/20 text-cyan-300 font-semibold text-[11px] shrink-0">
            ...
            <div className="flex items-center gap-1.5 ml-auto sm:ml-0">
              {onOpenDocs && (
                <button
                  type="button"
                  onClick={onOpenDocs}
                  className="px-2.5 py-1 rounded-lg bg-indigo-500/20 hover:bg-indigo-500/30 text-indigo-300 border border-indigo-500/40 text-[11px] font-semibold transition-colors flex items-center gap-1 shrink-0"
                >
              ...
              <button
                ...
                className="text-slate-400 hover:text-slate-200 p-1 rounded hover:bg-slate-800 shrink-0"
