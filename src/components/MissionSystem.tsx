        ...
        <div className="mt-6 pt-4 border-t border-slate-800 flex flex-wrap items-center justify-between gap-3 text-xs">
          ...
          <div className="flex items-center gap-2">
            ...
            <select
              ...
              className="bg-slate-950 border border-slate-800 rounded-lg px-2.5 py-1 text-slate-200 text-xs focus:outline-none focus:border-cyan-400"
            >
          ...
          return (
            ...
            >
              <div>
                ...
                <h3 className="text-base font-bold text-white mt-3 line-clamp-2">
                  {mission.title}
                </h3>
                ...
                <div className="flex flex-wrap gap-1 mt-3">
                  {mission.skillsPracticed.map((sk) => (
                    <span
                      key={sk}
                      className="text-[10px] px-2 py-0.5 rounded bg-slate-850 bg-slate-800 text-slate-300 border border-slate-700/60"
                    >
                      {sk}
                    </span>
                  ))}
